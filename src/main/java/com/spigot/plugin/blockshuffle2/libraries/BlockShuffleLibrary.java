...
public final class BlockShuffleLibrary {
    ...
    public static void prepareBlocks(){
        ...
        SUNFLOWER_PLAINS.addAll(FLOWER_PLAINS_BASE);
        SUNFLOWER_PLAINS.addAll(BEES);

        CHERRY_CRAFTS.addAll(BEES);

        MANGROVE_CRAFTS.addAll(BEES);

        SWAMP.addAll(MUSHROOMS);
        SWAMP.addAll(BOOKS);
        ...
        MUSHROOM_FIELDS.addAll(MUSHROOMS);
